...
const updateProductFromDB = async(productID : string , productInfo : ProductType) => {
    const result = await ProductModel.findByIdAndUpdate(productID , productInfo , {new : true});
    return result;
}
